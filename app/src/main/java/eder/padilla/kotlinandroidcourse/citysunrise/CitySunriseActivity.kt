package eder.padilla.kotlinandroidcourse.citysunrise
...
import kotlinx.android.synthetic.main.activity_city_sunrise.*
...
class CitySunriseActivity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_city_sunrise)
    }
